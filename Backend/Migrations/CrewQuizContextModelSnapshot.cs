...
namespace Backend.Migrations
{
    ...
    partial class CrewQuizContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Domains.PreviousGame", b =>
                {
                    b.Property<long>("PreviousGameId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnOrder(0);

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("PreviousGameId"));
                    ...
                    b.ToTable("PreviousGame");
                });

            modelBuilder.Entity("Backend.Models.Domains.PreviousGameUser", b =>
                {
                    b.Property<long>("PreviousGameId")
                        .HasColumnType("bigint")
                        .HasColumnOrder(0);
                    ...
                    b.HasKey("PreviousGameId", "UserId");

                    b.HasIndex("CreatedByUserId");

                    b.HasIndex("PreviousGameId");
                    ...
                    b.HasIndex("PreviousGameId", "UserId")
                        .IsUnique();

                    b.ToTable("PreviousGameUser");
                });
            ...
            modelBuilder.Entity("Backend.Models.Domains.PreviousGameUser", b =>
                {
                    ...
                    b.HasOne("Backend.Models.Domains.PreviousGame", "PreviousGame")
                        .WithMany("PreviousGameUsers")
                        .HasForeignKey("PreviousGameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Models.Domains.User", "UpdatedByUser")
                        .WithMany("UpdatedPreviousGameUsers")
                        .HasForeignKey("UpdatedByUserId");
            ...
            modelBuilder.Entity("Backend.Models.Domains.PreviousGame", b =>
                {
                    b.Navigation("PreviousGameUsers");
                });
            ...
            modelBuilder.Entity("Backend.Models.Domains.User", b =>
                {
                    ...
                    b.Navigation("UpdatedPreviousGameUsers");

                    b.Navigation("UpdatedPreviousGames");
